...
public class Api_Client {
	...
	private String usecTime() {
		 ...
		 * 
		 * System.out.println("elapsedTime ==> " + microseconds + " : " +
		 * seconds);
		 */
	...
	public String callApi(String endpoint, HashMap<String, String> params) throws IOException {
